...
!-----------------------------------------------------------------------
! @40:
!  character(shr_kind_cl), public :: bndtag = 'bndtag' ! full pathname for time-invaria
!
!----------------------------------------------------------------------- 
...
!
   ...
   character(shr_kind_cl), public :: bndtag = 'bndtag' ! full pathname for time-invariant isotope tagging dataset
