...
#undef O17HTO		/* define this to turn on h217o and hto, set pcnst=18 */
...
#ifdef O17HTO
  integer, parameter :: nspec = 5		! 3 species of water (h2o, hdo, o18, o17, hto)
#else
  integer, parameter :: nspec = 3		! 3 species of water (h2o, hdo, o18)
#endif
  integer, parameter :: ncnst = nwatr*nspec     ! 3 types, 3 species
!
